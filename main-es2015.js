...
/* harmony import */ var _components_weather_weather_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/weather/weather.component */ "./src/app/components/weather/weather.component.ts");
...
const routes = [
    { path: '', component: _components_weather_weather_component__WEBPACK_IMPORTED_MODULE_2__["WeatherComponent"] },
...
/* harmony import */ var _components_forecast_forecast_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/forecast/forecast.component */ "./src/app/components/forecast/forecast.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _components_favorites_favorites_component__WEBPACK_IMPORTED_MODULE_4__["FavoritesComponent"],
        _search_pipe__WEBPACK_IMPORTED_MODULE_6__["AccuweatherIconPipe"],
        _components_forecast_forecast_component__WEBPACK_IMPORTED_MODULE_12__["ForecastComponent"],
...
function ForecastComponent_div_2_Template(rf, ctx) { if (rf & 1) {
...
function ForecastComponent_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const cityForecast_r3 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
function ForecastComponent_div_4_Template(rf, ctx) { if (rf & 1) {
...
class ForecastComponent {
    ...
    ngOnInit() {
        this.weatherSub = this.weatherService.getTelAviv().subscribe((data) => {
            if (!data[0])
                return {};
            this.currentCity = data[0];
        });
        this.weatherWeekSub = this.weatherService.getFiveDaysForecast(this.cityID).subscribe((data) => {
...
ForecastComponent.ɵfac = function ForecastComponent_Factory(t) { return new (t || ForecastComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_weather_service__WEBPACK_IMPORTED_MODULE_1__["WeatherService"])); };
ForecastComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ForecastComponent, selectors: [["app-forecast"]], inputs: { currentCity: "currentCity" }, decls: 5, vars: 2, consts: [[1, "container"], [1, "row"], ["class", "current", 4, "ngIf"], ["class", "row", 4, "ngIf"], [1, "current"], ["class", "bigCard bg-light mb-3", "style", "max-width: 18rem;", 4, "ngFor", "ngForOf"], [1, "bigCard", "bg-light", "mb-3", 2, "max-width", "18rem"], [1, "card-header"], [1, "card-body"], [1, "card-title"], [1, "card-icon"], [3, "src"]], template: function ForecastComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ForecastComponent, [{
    ...
    }], function () { return [{ type: _services_weather_service__WEBPACK_IMPORTED_MODULE_1__["WeatherService"] }]; }, { currentCity: [{
...
function HeaderComponent_li_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const navButton_r1 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 8, vars: 1, consts: [[1, "navbar", "navbar-expand-md", "stiky-top"], [1, "container-fluid"], ["routerLink", "/", 1, "navbar-brand"], ["src", "../assets/pngfuel.jpg.png"], [1, "collapse", "navbar-collapse"], [1, "navbar-nav", "ml-auto"], ["class", "nav-item", 4, "ngFor", "ngForOf"], [1, "nav-item"], [1, "nav-link", 3, "routerLink"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _forecast_forecast_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../forecast/forecast.component */ "./src/app/components/forecast/forecast.component.ts");
...
function WeatherComponent_mat_option_7_Template(rf, ctx) { if (rf & 1) {
...
class WeatherComponent {
    ...
    ngOnInit() {
        this.filteredCities = this.control.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(value => this.autoCompleteSearch(value)));
    }
    currentConditions() {
        this.weatherService.getCurrentConditions(this.cityID).subscribe((data) => {
            this.currentCity = data[0];
        });
        this.weatherService.getFiveDaysForecast(this.cityID).subscribe((data) => {
            this.currentCity.Daily = data.DailyForecasts;
        });
    }
    autoCompleteSearch(value) {
        this.weatherService.getAutoCompleteSerach(value).subscribe((data) => {
            if (!data)
                return [];
...
WeatherComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: WeatherComponent, selectors: [["app-weather"]], decls: 10, vars: 6, consts: [[1, "navbar", "navbar-light", "bg-light"], [1, "form-inline"], ["type", "search", "placeholder", "Search for city", "aria-label", "Search", 1, "form-control", "mr-sm-2", 3, "formControl", "matAutocomplete"], ["type", "button", 1, "btn", "btn-outline-secondary", "my-2", "my-sm-0", 3, "click"], ["auto", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], [3, "currentCity"], [3, "value"]], template: function WeatherComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "input", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "button", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function WeatherComponent_Template_button_click_3_listener() { return ctx.currentConditions(); });
...
const icons = `https://developer.accuweather.com/sites/default/files`;
...
module.exports = __webpack_require__(/*! C:\Users\DORON-LAP\Documents\TCWD - 2\Projects\shai-zur-28-07-2020\src\main.ts */"./src/main.ts");
